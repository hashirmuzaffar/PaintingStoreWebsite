 ...
 * @author hashi
 */
public class retieveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try ( PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                runIfOpened(myCon);
                String qry = "BEGIN return_painting(?,?); END;";
                ...
                if(r == 1){
                out.println("<h2 class='heading heading2'>Painting was Succesfully Returned!</h2>");
                out.println(C_no + "<h2 class='heading'> has returned</h><br>");
